...
> 周期：每周日运行 | 自动化等级：半自动 | 最后运行：2026-08-30
...
| 2026-08-23 | ~30–34/D (Labubu) / **~73–79/B (Twinkle)** / ~65–69/**B** (DIMOO) / ~64–68/**B** (Crybaby) / ~60–64/C (Skullpanda) / ~54–58/C (Molly) / ~51–57/C (HACIPUPU) | **43% (3/7 A/B)** → 持平 | 🔴 多IP接力收入结构获财务验证(历史性转折)。H1中报：THE MONSTERS -7.5%(占比26%) vs 星星人 +580.6%(第二大IP)+CRYBABY+34%+DIMOO+SKULLPANDA+HIRONO共5个非Labubu IP过10亿。星星人动物农场秒罄四层验证齐备。MOLLY -33.6%掉出前三成最大负面。Labubu收入拐点官方确认+能力③首次检验偏负面。管理层放弃20%目标+20-50亿回购。股价8/21裂口低开8.2%收跌3.06%至149 | [[2026-08-23\|查看]] |
| 2026-08-30 | ~36–40/D (Labubu) / **~66–71/B (Twinkle)** / **~64–68/B (DIMOO)** / **~63–67/B (Crybaby)** / ~60–64/C (Skullpanda) / ~53–58/C (HACIPUPU) / ~52–56/C (Molly) | **43% (3/7 A/B)** → 持平 | 🟢 Labubu新品需求强vs老款存量退潮分化。8/28迷你版LABUBU 60秒售罄(天猫10分钟30万件/2300万/电商超100万件/单只17x溢价/8/29线下排队)——「需求崩塌」叙事最强反证，能力③修正为新品需求仍强。星星人动物农场溢价快速退潮(隐藏13x→5x、常规款10天破发)，首发30天正溢价测试偏负(投机层)。HACIPUPU×蜡笔小新8/27开售(L2落地无L3/L4)。CRYBABY Care Bears 20+天无二手悬案延续。多IP接力维持财务验证。股价周+6.5%至158.70站上50天线，回购未执行南向转净流出 | [[2026-08-30\|查看]] |

...
#### 模块 2：行业位置与壁垒必查：
- 主要客户、认证、量产、份额
- 行业中的角色：设备商、零部件商、平台商、运营商要回答：
- 它是行业龙头、跟随者，还是单一客户附庸
- 护城河来自技术、客户认证、成本、规模，还是仅靠景气红旗：
- 只说布局，不说量产和客户
- 只说未来空间，不说当前竞争位置

**波特五力分析（每家公司必做，写入公司页）**

用五个维度评估竞争结构，每项给出🔴强/🟡中/🟢弱三档评级：

| 维度 | 评级（对公司的不利程度） | 分析要点 |
|---|---|---|
| 买方议价能力 | ? | 客户集中度、转移成本、品牌溢价能力 |
| 供应商议价能力 | ? | 原材料依赖度、替代来源、成本转嫁能力 |
| 同行竞争激烈程度 | ? | 行业集中度CR5、价格战风险、差异化程度 |
| 替代品威胁 | ? | 技术替代、需求转移、跨界竞争 |
| 新进入者威胁 | ? | 资质壁垒、资本门槛、规模效应 |

综合评定护城河强度（⭐1-5星）及主要结构性弱点，写入公司页"波特五力分析"区块。

> **评级逻辑**：买方/供应商/竞争三项"强"对公司不利（🔴）；替代品/新进入者威胁"低"对公司有利（🟢）。护城河越强，后三项越绿，前两项影响越小。

**定价权评估（每家公司必做，结果写入公司页"定价权评估"区块）**

定价权是护城河的最直接财务体现——能主动提价、且客户不轻易流失的公司，才是真正有壁垒的公司。

**第一步：判断定价权来源**

| 来源类型 | 典型特征 | 常见行业 |
|---|---|---|
| 品牌溢价 | 消费者愿意为品牌支付价格差，竞品存在但选择此品牌 | 白酒、奢侈消费品、医美、饮料 |
| 客户转移成本 | 切换供应商需要重新认证、培训、系统对接，成本高 | 工业软件、医疗设备、关键零部件 |
| 网络效应 | 用户越多价值越高，后来者难以替代 | 交易平台、社交软件、支付系统 |
| 监管/资质壁垒 | 牌照、GMP、军工资质等准入限制竞争 | 药品、金融、航空、特种设备 |
| 成本领先 | 规模/技术优势使成本远低于竞品，可在竞争中主动定价 | 光伏、锂电、化工 |
| 垂直整合/独家供应 | 上下游锁定，无替代来源 | 稀土、特种材料、核心部件 |
| 无（纯价格竞争） | 同质化产品，价格由市场决定，无提价能力 | 大宗商品、低端制造、贸易 |

**第二步：用历史数据验证定价权是否真实存在**

- **毛利率趋势**（最直接指标）：近 3-5 年毛利率稳定或上升 → 有定价权；持续下滑 → 定价权弱或正在被侵蚀
- **提价历史**：公司是否有过主动提价记录？提价后出货量/市占率是否基本稳定？
- **成本传导能力**：原材料价格上涨时，是否能将成本转嫁给下游（毛利率保持稳定）？还是只能自己消化？
- **毛利率 vs 行业均值**：若毛利率持续高于同行 10pct 以上，通常是定价权的财务佐证

**第三步：定价权综合评级**

| 评级 | 标准 | 对结论的影响 |
|---|---|---|
| ⭐⭐⭐ 强定价权 | 有明确来源 + 历史毛利率稳定/上升 + 有过成功提价记录 | 估值可给更高溢价，ROE 持续性更强 |
| ⭐⭐ 中等定价权 | 有一定壁垒，但受竞争制约，毛利率波动 | 正常估值，关注竞争格局变化 |
| ⭐ 弱定价权 | 主要靠成本控制或量的增长维持利润，无法主动提价 | 利润天花板较低，高 PE 需谨慎 |
| ❌ 无定价权 | 纯价格竞争，行业均价决定利润 | 估值折价，周期属性强，避免在景气顶部买入 |

红旗：
- 🔴 毛利率近 3 年持续下滑超过 5pct，同时竞争对手数量增加 → 定价权正在瓦解
- 🔴 公司将提价失败归咎于「行业竞争激烈」但无法说明改善路径 → 无护城河
- 🟡 毛利率高于同行但主要依赖单一大客户（客户议价能力实质上在对方手里）
- 🟡 声称品牌溢价，但终端价格与竞品差距在收窄

> ⚠️ **定价权与周期的交叉判断**：周期股（如煤炭、化工）在景气期看似有定价权，实为价格周期红利，并非真定价权。需区分「市场价格上涨带来的被动受益」vs「公司主动提价客户不走的真定价权」。

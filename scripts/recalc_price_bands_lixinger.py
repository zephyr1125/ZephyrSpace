...
# ── 映射表：中证全指代码 → 申万2021代码（closest match）
# 中证全指行业指数对应最接近的申万2021一级行业
INDUSTRY_MAP = {
    "931932": "630000",   # 电力设备与新能源 → 电力设备
    "H30166": "640000",   # 机械制造 → 机械设备
    "931931": "620000",   # 建筑装饰 → 建筑装饰
    "931933": "760000",   # 环保 → 环保
    "932111": "220000",   # 化工行业 → 基础化工
    "932116": "650000",   # 航空航天与国防 → 国防军工
    "931940": "370500",   # 医疗（含器械+服务）→ 医疗器械（二级，最接近）
    "H30179": "370000",   # 医药 → 医药生物
    "H30177": "340000",   # 食品饮料烟草 → 食品饮料
    "H30175": "450000",   # 零售业 → 商贸零售
    "H30164": "280500",   # 乘用车及零部件 → 乘用车（二级）
    "H30186": "490200",   # 保险 → 保险（二级）
    "H30211": "490000",   # 资本市场 → 非银金融
    "H30183": "270000",   # 电子 → 电子
    "932077": "750000",   # 能源行业 → 石油石化
    "932078": "240000",   # 原材料行业 → 有色金属（近似，含化工/有色/钢铁）
    "932079": "640000",   # 工业行业 → 机械设备（近似）
    "932080": "280000",   # 可选消费 → 汽车（近似，含汽车/家电/轻工等）
    "932081": "340000",   # 主要消费 → 食品饮料（近似）
    "932082": "370000",   # 医药卫生 → 医药生物
    "932083": "490000",   # 金融行业 → 非银金融（含银行/非银）
    "932084": "710000",   # 信息技术 → 计算机
    "932085": "730000",   # 通信服务 → 通信
    "932086": "410000",   # 公用事业 → 公用事业
}

# 注意：932078/932079/932080/932081/932083 是宽行业篮子，映射为最大权重子行业
# 这些指数 PE 分位数据仅供参考，实际包含多个申万行业

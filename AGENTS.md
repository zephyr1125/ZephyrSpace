...
|---|---|---|---|---|---|---|---|
| **成长科技** | AI、半导体、军工、卫星通信 | 40亿 | 60x | 12% | 无 | ≥-10% | ROE降序 |
| **消费/医药** | 白酒、食品、医药生物 | 40亿 | 40x | 15% | 无 | ≥-15% | ROE降序 |
| **公用事业/能源** | 电力、水务、燃气、绿电 | 40亿 | 20x | 8% | ≥4% | ≥-15% | 股息率降序 |
| **周期/材料** | 化工、钢铁、煤炭、有色 | 40亿 | 15x | 10% | ≥3% | ≥-20% | PB升序（越低越好） |
| **金融** | 银行、保险、证券 | 100亿 | — | 10% | ≥4% | ≥-10% | 改用PB≤1.5x替代PE |
| **通用/混合** | 宽基或跨行业主题 | 40亿 | 35x | 12% | 无 | ≥-15% | ROE降序 |
...
市值下限固定 ≥ 40亿（金融类 ≥ 100亿）；其余 PE/ROE/股息率/营收同比门槛查表。
